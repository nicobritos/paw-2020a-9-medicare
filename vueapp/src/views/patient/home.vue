        ...
        <div class="row h-100">
            <div class="col h-100 pl-0 mr-5 w-100">
                <ul class="list-group turno-list mr-2 w-100 h-100 overflow-auto">
                    ...
                    <li v-for="appointment in appointments" :key="appointment.id" class="list-group-item turno-item mb-3">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="row justify-content-start">
                                        <h5>{{appointment.staff.user.firstName}} {{appointment.staff.user.surname}}</h5>
                                    </div>
                                    <div class="row">
                                        <p class="m-0">
                                            <!-- TODO: check -->
