...
create sequence if not exists system_province_province_id_seq minvalue 0 start with 0;
...
create sequence if not exists system_staff_specialty_specialty_id_seq minvalue 0 start with 0;
...
create sequence if not exists system_locality_locality_id_seq minvalue 0 start with 0;
...
create sequence if not exists office_office_id_seq minvalue 0 start with 0;
...
create sequence if not exists picture_picture_id_seq minvalue 0 start with 0;
...
create sequence if not exists users_users_id_seq minvalue 0 start with 0;
...
create sequence if not exists staff_staff_id_seq minvalue 0 start with 0;
...
create sequence if not exists patient_patient_id_seq minvalue 0 start with 0;
...
create sequence if not exists appointment_appointment_id_seq minvalue 0 start with 0;
...
create sequence if not exists workday_workday_id_seq minvalue 0 start with 0;
