...
public class StaffDaoImplTest
{
    ...
    public void testFindByName(){
        ...
        // 2. Ejercitar
        Collection<Staff> staffs = this.staffDao.findBy(NAME, null, null, null, null);
    ...
    public void testFindBySurname(){
        ...
        // 2. Ejercitar
        Collection<Staff> staffs = this.staffDao.findBy(null, SURNAME, null, null, null);
...
//
    ...
    public void testFindByNameAndStaffSpecialties(){
        ...
        // 2. Ejercitar
        Collection<Staff> staffs = this.staffDao.findBy(NAME, null, null, Collections.singletonList(this.staffSpecialtyModel()), null);
    ...
    public void testFindByNameOfficeAndStaffSpecialties(){
        ...
        // 2. Ejercitar
        Collection<Staff> staffs = this.staffDao.findBy(NAME, null, Collections.singletonList(this.officeModel()), Collections.singletonList(this.staffSpecialtyModel()), null);
    ...
    public void testFindByOfficeAndStaffSpecialties(){
        ...
        // 2. Ejercitar
        Collection<Staff> staffs = this.staffDao.findBy((String) null, null, Collections.singletonList(this.officeModel()), Collections.singletonList(this.staffSpecialtyModel()), null);
    ...
    public void testFindByStaffSpecialties(){
        ...
        // 2. Ejercitar
        Collection<Staff> staffs = this.staffDao.findBy((String) null, null, null, Collections.singletonList(this.staffSpecialtyModel()), null);
