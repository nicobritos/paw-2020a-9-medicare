    ...
    <div class="row h-100">
        ...
        <div class="col">
            ...
            <table class="table table-borderless">
                <tr>
                    <td class="px-0"><button type="button" class="btn" id="prevWeekBtn"><</button></td>
                    <c:forEach var="i" begin="0" end="6">
                        <td class="px-0">
                            <!-- day of the week -->
                            <span class="medicare-day-span container px-0 mx-2 d-flex flex-column align-items-center" data-day="<c:out value="${monday.plusDays(i)}"/>"
                              <c:if test="${monday.plusDays(i).dayOfYear == today.dayOfYear && monday.plusDays(i).year == today.year}">style="font-weight:bold"</c:if>>
                                ...
                                <!-- day/month -->
                                <p class="my-0"><c:out value="${monday.plusDays(i).dayOfMonth}"/> <spring:message code="of"/>
                                    <c:choose>
